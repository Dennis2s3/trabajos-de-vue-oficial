...
<div class="container bg-light rounded-3">
    <form action="#"  >
        <div class="row ">
            <h2 class="text-center mb-4 mt-5">Informacion Personal</h2>
            <div class="col">
        ...
        <div class="row  mb-5">
            <button type="submit" class="btn btn-dark w-50 mb-5  m-auto" @click.prevent="procesarFormularios">Enviar</button>
        </div>
    </form>
</div>
</template>
